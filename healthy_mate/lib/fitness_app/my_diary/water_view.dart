...
import 'package:healthy_mate/fitness_app/ui_view/wave_view.dart';
                            ...
                            Column(
                              ...
                              children: <Widget>[
                                Row(
                                  ...
                                  children: <Widget>[
                                    Consumer<IFoodViewModel>(
                                        builder: (context, vm, child) {
                                      return Padding(
                                        padding: const EdgeInsets.only(
                                            left: 4, bottom: 3),
                                        child: Text(
                                          vm.dailyFoodLog?.waterIntake
                                                  .toString() ??
                                              '0',
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            vm.dailyFoodLog?.lastDrinkTime !=
                                                    null
                                                ? 'Uống lần cuối: ${DateFormat('hh:mm dd/MM').format(vm.dailyFoodLog!.lastDrinkTime!)}'
                                                : 'Chưa có dữ liệu',
                                            textAlign: TextAlign.center,
                                            style: TextStyle(
                                              fontFamily:
                            ...
                            InkWell(
                              onTap: () async {
                                await DbHelper.instance
                                    .changeWaterIntake(true)
                                    .then(
                                  (value) async {
                                    await _iFoodViewModel.fetchFoodLog();
                                  },
                                );
                              },
                              child: Container(
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Consumer<IFoodViewModel>(
                              builder: (context, vm, child) {
                            return WaveView(
                              percentageValue: vm.dailyFoodLog != null
                                  ? (vm.dailyFoodLog!.waterIntake! / 2000) * 100
                                  : 0,
                            );
                          }),
                        ),
