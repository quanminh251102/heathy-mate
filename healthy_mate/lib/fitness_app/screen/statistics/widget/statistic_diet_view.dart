...
class StatisticMediterranesnDietView extends StatelessWidget {
  final AnimationController? animationController;
  final Animation<double>? animation;

  const StatisticMediterranesnDietView(
                                                ...
                                                Padding(
                                                  padding:
                                                      const EdgeInsets.only(
                                                          left: 4, bottom: 3),
                                                  child: Text(
                                                    '${(locator<GlobalData>().currentUser!.bmr! * animation!.value).toInt()}',
                                                    textAlign: TextAlign.center,
