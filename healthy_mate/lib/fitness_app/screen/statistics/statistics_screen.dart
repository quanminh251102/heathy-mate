...
import 'package:healthy_mate/fitness_app/screen/statistics/widget/statistic_body_measurement.dart';
import 'package:healthy_mate/fitness_app/screen/statistics/widget/statistic_diet_view.dart';
import 'package:healthy_mate/fitness_app/screen/statistics/widget/statistic_water_view.dart';
          ...
          return SingleChildScrollView(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  InfoTitleView(
                    titleTxt: 'Lượng Calorie tối thiểu hàng ngày',
                  ...
                  StatisticMediterranesnDietView(
                    animation: Tween<double>(begin: 0.0, end: 1.0).animate(
                        CurvedAnimation(
                            parent: animationController!,
                  ...
                  InfoTitleView(
                    titleTxt: 'Lượng nước tối thiểu hàng ngày',
                    animation: Tween<double>(begin: 0.0, end: 1.0).animate(
                        CurvedAnimation(
                            parent: animationController!,
                            curve: const Interval((1 / 9) * 0, 1.0,
