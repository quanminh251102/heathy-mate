...
import 'package:healthy_mate/fitness_app/screen/food_detail/widget/nutrition_chart.dart';
import 'package:healthy_mate/fitness_app/screen/food_detail/widget/training_plan.dart';
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            FoodNutritionChart(
              foodItemDto: widget.foodItemDto,
              animation: Tween<double>(begin: 0.0, end: 1.0).animate(
                  CurvedAnimation(
                      parent: animationController!,
            ...
            InfoTitleView(
              titleTxt:
                  'Kế hoạch tập luyện để tiêu hao ${widget.foodItemDto.nutritionalInfo!.kcal.toString()} Kcal',
              animation: Tween<double>(begin: 0.0, end: 1.0).animate(
                CurvedAnimation(
                  parent: animationController!,
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              ...
                              child: Text(
                                widget.foodItemDto.name.toString(),
